...
def export_model(model_path="./runs/detect/runs/train/Train_scanner/weights/best.pt"):
    ...
    path = model.export(format="openvino", imgsz=640, opset=12, data="data.yaml") # Quantization to int8 with data.yaml for calibration
